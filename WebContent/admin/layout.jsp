					...
					<div class="flex scrollable hover">
						<div class="nav-border b-primary" data-nav>
							<ul class="nav bg">
								...
								<li><a href="home" class="nav-text" name="home"><span class="nav-icon"><i data-feather="home"></i></span>Home</a></li>
								<li><a href="admin/video" class="nav-text" name="adminvideo"><span class="nav-icon"><i
											data-feather="film"></i></span>Video Management</a></li>
								<li><a href="admin/users" class="nav-text" name="adminuser"><span class="nav-icon"><i
											data-feather="user"></i></span>User Management</a></li>
